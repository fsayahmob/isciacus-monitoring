...
export function AuditWelcome({
  lastAudit,
  hasIssues,
  onStart,
}: AuditWelcomeProps): React.ReactElement {
  return (
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium text-gray-900">
              {new Date(lastAudit).toLocaleDateString('fr-FR', {
                day: 'numeric',
                month: 'long',
                hour: '2-digit',
                minute: '2-digit',
          ...
          <div className="flex items-center justify-between">
            ...
            <span
              className={`rounded-full px-3 py-1 text-xs font-medium ${hasIssues === true ? 'bg-amber-100 text-amber-800' : 'bg-green-100 text-green-800'}`}
            >
