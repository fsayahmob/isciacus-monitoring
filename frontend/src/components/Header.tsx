        ...
        <div className="view-toggle flex overflow-hidden rounded border border-burgundy">
          <button
            className={`flex items-center gap-1.5 px-3 py-1.5 text-sm transition-colors ${
              viewMode === VIEW_MODES.GRID ? 'bg-burgundy text-white' : ''
            }`}
            type="button"
            onClick={() => {
              handleViewChange(VIEW_MODES.GRID)
            }}
          >
          ...
          <button
            className={`flex items-center gap-1.5 px-3 py-1.5 text-sm transition-colors ${
              viewMode === VIEW_MODES.LIST ? 'bg-burgundy text-white' : ''
            }`}
            type="button"
            onClick={() => {
              handleViewChange(VIEW_MODES.LIST)
            }}
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
