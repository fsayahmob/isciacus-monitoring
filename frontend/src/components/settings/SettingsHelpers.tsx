...
export function ProgressBar({ configured, total }: { configured: number; total: number }): React.ReactElement {
  return (
    <div className="mt-6 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between text-sm">
        <span className="font-medium text-gray-700">Progression de la configuration</span>
        <span className="text-gray-500">{configured} / {total} services configurés</span>
      </div>
